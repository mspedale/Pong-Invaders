...
public class playerControl : MonoBehaviour
{
	...
	{
		if (coll.gameObject.name == "playerProjectile2(Clone)" || coll.gameObject.name == "InvaderProjectile1(Clone)" || coll.gameObject.name == "redProjectile(Clone)" || coll.gameObject.tag == "invader")
		{
			hp--;
		}
    }
